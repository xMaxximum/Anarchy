...
namespace Discord
{
    ...
    {
        #region management
        public static async Task<DiscordMessage> SendMessageAsync(this IRestClient client, ulong channelId, MessageProperties properties)
        {
        ...
        public static DiscordMessage SendMessage(this IRestClient client, ulong channelId, MessageProperties properties)
        {
            return client.SendMessageAsync(channelId, properties).GetAwaiter().GetResult();
        }

        public static async Task<DiscordMessage> SendMessageAsync(this IRestClient client, ulong channelId, string message, bool tts = false, DiscordEmbed embed = null)
        {
        ...
        public static DiscordMessage SendMessage(this IRestClient client, ulong channelId, string message, bool tts = false, DiscordEmbed embed = null)
        {
            return client.SendMessageAsync(channelId, message, tts, embed).GetAwaiter().GetResult();
        }

        public static async Task<DiscordMessage> SendMessageAsync(this IRestClient client, ulong channelId, EmbedMaker embed)
        {
            return await client.SendMessageAsync(channelId, new MessageProperties() { Embed = embed });
        }

        public static DiscordMessage SendMessage(this IRestClient client, ulong channelId, EmbedMaker embed)
        {
            return client.SendMessageAsync(channelId, embed).GetAwaiter().GetResult();
        }

        public static async Task<DiscordMessage> SendFileAsync(this IRestClient client, ulong channelId, string fileName, byte[] fileData, string message = null, bool tts = false)
        {
        ...
        /// <param name="message">Contents of the message</param>
        /// <param name="tts">Whether the message should be TTS or not</param>
        public static DiscordMessage SendFile(this IRestClient client, ulong channelId, string fileName, byte[] fileData, string message = null, bool tts = false)
        {
            return client.SendFileAsync(channelId, fileName, fileData, message, tts).GetAwaiter().GetResult();
        }

        public static async Task<DiscordMessage> SendFileAsync(this IRestClient client, ulong channelId, string filePath, string message = null, bool tts = false)
        {
        ...
        /// <param name="message">Contents of the message</param>
        /// <param name="tts">Whether the message should be TTS or not</param>
        public static DiscordMessage SendFile(this IRestClient client, ulong channelId, string filePath, string message = null, bool tts = false)
        {
            return client.SendFileAsync(channelId, filePath, message, tts).GetAwaiter().GetResult();
        }

        public static async Task<DiscordMessage> EditMessageAsync(this IRestClient client, ulong channelId, ulong messageId, MessageEditProperties properties)
        {
        ...
        public static DiscordMessage EditMessage(this IRestClient client, ulong channelId, ulong messageId, MessageEditProperties properties)
        {
            return client.EditMessageAsync(channelId, messageId, properties).GetAwaiter().GetResult();
        }

        public static async Task DeleteMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        public static void DeleteMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        public static void DeleteMessages(this IRestClient client, ulong channelId, List<ulong> messages)
        {
            client.DeleteMessagesAsync(channelId, messages).GetAwaiter().GetResult();
        }
        #endregion

        public static async Task TriggerTypingAsync(this IRestClient client, ulong channelId)
        {
            var resp = await client.HttpClient.PostAsync($"/channels/{channelId}/typing");

            if (resp.ToString().Contains("cooldown"))
                throw new RateLimitException(resp.Deserialize<JsonObject>()["message_send_cooldown_ms"].GetValue<int>());
        }
        ...
        /// </summary>
        /// <param name="channelId">ID of the channel</param>
        public static void TriggerTyping(this IRestClient client, ulong channelId)
        {
        ...
        public static async Task<IReadOnlyList<DiscordMessage>> GetChannelMessagesAsync(this IRestClient client, ulong channelId, MessageFilters filters = null)
        {
            if (filters == null)
        ...
        public static IReadOnlyList<DiscordMessage> GetChannelMessages(this IRestClient client, ulong channelId, MessageFilters filters = null)
        {
        ...
        public static async Task<IReadOnlyList<DiscordMessage>> GetChannelMessagesAsync(this IRestClient client, ulong channelId, uint limit)
        {
            return await client.GetChannelMessagesAsync(channelId, new MessageFilters() { Limit = limit });
        }

        public static IReadOnlyList<DiscordMessage> GetChannelMessages(this IRestClient client, ulong channelId, uint limit)
        {
            return client.GetChannelMessagesAsync(channelId, limit).GetAwaiter().GetResult();
        }

        public static async Task<IReadOnlyList<DiscordUser>> GetMessageReactionsAsync(this IRestClient client, ulong channelId, ulong messageId, ReactionQuery query)
        {
        ...
        public static IReadOnlyList<DiscordUser> GetMessageReactions(this IRestClient client, ulong channelId, ulong messageId, ReactionQuery query)
        {
            return client.GetMessageReactionsAsync(channelId, messageId, query).GetAwaiter().GetResult();
        }

        public static async Task AddMessageReactionAsync(this IRestClient client, ulong channelId, ulong messageId, string reactionName, ulong? reactionId = null)
        {
        ...
        public static void AddMessageReaction(this IRestClient client, ulong channelId, ulong messageId, string reactionName, ulong? reactionId = null)
        {
            client.AddMessageReactionAsync(channelId, messageId, reactionName, reactionId).GetAwaiter().GetResult();
        }

        private static async Task removeReactionAsync(this IRestClient client, ulong channelId, ulong messageId, string user, string reactionName, ulong? reactionId = null)
        {
        ...
        public static async Task RemoveMessageReactionAsync(this IRestClient client, ulong channelId, ulong messageId, string reactionName, ulong? reactionId = null)
        {
            await client.removeReactionAsync(channelId, messageId, "@me", reactionName, reactionId);
        }

        public static void RemoveMessageReaction(this IRestClient client, ulong channelId, ulong messageId, string reactionName, ulong? reactionId)
        {
            client.RemoveMessageReactionAsync(channelId, messageId, reactionName, reactionId).GetAwaiter().GetResult();
        }

        public static async Task RemoveMessageReactionAsync(this IRestClient client, ulong channelId, ulong messageId, ulong userId, string reactionName, ulong? reactionId = null)
        {
            await client.removeReactionAsync(channelId, messageId, userId.ToString(), reactionName, reactionId);
        }

        public static void RemoveMessageReaction(this IRestClient client, ulong channelId, ulong messageId, ulong userId, string reactionName, ulong? reactionId = null)
        {
        ...
        public static Task<IReadOnlyList<DiscordMessage>> GetChannelPinnedMessagesAsync(this IRestClient client, ulong channelId)
        {
            return null;
        }

        public static async Task<IReadOnlyList<DiscordMessage>> GetPinnedMessagesAsync(this IRestClient client, ulong channelId)
        {
        ...
        public static IReadOnlyList<DiscordMessage> GetChannelPinnedMessages(this IRestClient client, ulong channelId)
        {
            return null;
        }
        ...
        /// </summary>
        /// <param name="channelId">ID of the channel</param>
        public static IReadOnlyList<DiscordMessage> GetPinnedMessages(this IRestClient client, ulong channelId)
        {
        ...
        public static Task PinChannelMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
            return null;
        }

        public static async Task PinMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        public static void PinChannelMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        /// <param name="channelId">ID of the channel</param>
        /// <param name="messageId">ID of the message</param>
        public static void PinMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
            client.PinMessageAsync(channelId, messageId).GetAwaiter().GetResult();
        }

        public static async Task UnpinChannelMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        /// <param name="channelId">ID of the channel</param>
        /// <param name="messageId">ID of the message</param>
        public static void UnpinChannelMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
            client.UnpinChannelMessageAsync(channelId, messageId).GetAwaiter().GetResult();
        }
        #endregion

        public static async Task<DiscordMessage> CrosspostMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
        ...
        public static DiscordMessage CrosspostMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
            return client.CrosspostMessageAsync(channelId, messageId).GetAwaiter().GetResult();
        }

        public static async Task AcknowledgeMessageAsync(this IRestClient client, ulong channelId, ulong messageId)
        {
            await client.HttpClient.PostAsync($"/channels/{channelId}/messages/{messageId}/ack", "{\"token\":null}");
        }

        public static void AcknowledgeMessage(this IRestClient client, ulong channelId, ulong messageId)
        {
