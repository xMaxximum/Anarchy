...
namespace Discord
{
    ...
    {
        public static async Task<IReadOnlyList<AuthorizedApp>> GetAuthorizedAppsAsync(this IRestClient client)
        {
            return (await client.HttpClient.GetAsync($"/oauth2/tokens"))
                                .Deserialize<IReadOnlyList<AuthorizedApp>>().SetClientsInList(client);
        }

        public static IReadOnlyList<AuthorizedApp> GetAuthorizedApps(this IRestClient client)
        {
            return client.GetAuthorizedAppsAsync().GetAwaiter().GetResult();
        }

        public static async Task DeauthorizeAppAsync(this IRestClient client, ulong appId)
        {
            await client.HttpClient.DeleteAsync("/oauth2/tokens/" + appId);
        }

        public static void DeauthorizeApp(this IRestClient client, ulong appId)
        {
            client.DeauthorizeAppAsync(appId).GetAwaiter().GetResult();
        }

        public static async Task AuthorizeBotAsync(this IRestClient client, ulong botId, ulong guildId, DiscordPermission permissions, string captchaKey)
        {
        ...
        public static void AuthorizeBot(this IRestClient client, ulong botId, ulong guildId, DiscordPermission permissions, string captchaKey)
        {
            client.AuthorizeBotAsync(botId, guildId, permissions, captchaKey).GetAwaiter().GetResult();
        }

        public static async Task<string> AuthorizeAppAsync(this IRestClient client, ulong appId, string scope)
        {
        ...
        public static string AuthorizeApp(this IRestClient client, ulong appId, string scope)
        {
            return client.AuthorizeAppAsync(appId, scope).GetAwaiter().GetResult();
        }

        public static async Task<IReadOnlyList<OAuth2Application>> GetApplicationsAsync(this IRestClient client)
        {
        ...
        /// </summary>
        public static IReadOnlyList<OAuth2Application> GetApplications(this IRestClient client)
        {
            return client.GetApplicationsAsync().GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> GetApplicationAsync(this IRestClient client, ulong id)
        {
        ...
        public static OAuth2Application GetApplication(this IRestClient client, ulong id)
        {
            return client.GetApplicationAsync(id).GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> CreateApplicationAsync(this IRestClient client, string name)
        {
        ...
        public static OAuth2Application CreateApplication(this IRestClient client, string name)
        {
            return client.CreateApplicationAsync(name).GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> ModifyApplicationAsync(this IRestClient client, ulong id, DiscordApplicationProperties properties)
        {
        ...
        public static OAuth2Application ModifyApplication(this IRestClient client, ulong id, DiscordApplicationProperties properties)
        {
            return client.ModifyApplicationAsync(id, properties).GetAwaiter().GetResult();
        }

        public static async Task<ApplicationBot> AddBotToApplicationAsync(this IRestClient client, ulong appId)
        {
        ...
        /// <returns></returns>
        public static ApplicationBot AddBotToApplication(this IRestClient client, ulong appId)
        {
            return client.AddBotToApplicationAsync(appId).GetAwaiter().GetResult();
        }

        public static async Task DeleteApplicationAsync(this IRestClient client, ulong appId)
        {
        ...
        public static void DeleteApplication(this IRestClient client, ulong appId)
        {
