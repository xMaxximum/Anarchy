...
namespace Discord
{
    ...
    {
        public static async Task<IReadOnlyList<AuthorizedApp>> GetAuthorizedAppsAsync(this RestClient<IUserClient> client)
        {
            return (await client.HttpClient.GetAsync($"/oauth2/tokens"))
                                .Deserialize<IReadOnlyList<AuthorizedApp>>().SetClientsInList(client);
        }

        public static IReadOnlyList<AuthorizedApp> GetAuthorizedApps(this RestClient<IUserClient> client)
        {
            return client.GetAuthorizedAppsAsync().GetAwaiter().GetResult();
        }

        public static async Task DeauthorizeAppAsync(this RestClient<IUserClient> client, ulong appId)
        {
            await client.HttpClient.DeleteAsync("/oauth2/tokens/" + appId);
        }

        public static void DeauthorizeApp(this RestClient<IUserClient> client, ulong appId)
        {
            client.DeauthorizeAppAsync(appId).GetAwaiter().GetResult();
        }

        public static async Task AuthorizeBotAsync(this RestClient<IUserClient> client, ulong botId, ulong guildId, DiscordPermission permissions, string captchaKey)
        {
        ...
        public static void AuthorizeBot(this RestClient<IUserClient> client, ulong botId, ulong guildId, DiscordPermission permissions, string captchaKey)
        {
            client.AuthorizeBotAsync(botId, guildId, permissions, captchaKey).GetAwaiter().GetResult();
        }

        public static async Task<string> AuthorizeAppAsync(this RestClient<IUserClient> client, ulong appId, string scope)
        {
        ...
        public static string AuthorizeApp(this RestClient<IUserClient> client, ulong appId, string scope)
        {
            return client.AuthorizeAppAsync(appId, scope).GetAwaiter().GetResult();
        }

        public static async Task<IReadOnlyList<OAuth2Application>> GetApplicationsAsync(this RestClient<IUserClient> client)
        {
        ...
        /// </summary>
        public static IReadOnlyList<OAuth2Application> GetApplications(this RestClient<IUserClient> client)
        {
            return client.GetApplicationsAsync().GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> GetApplicationAsync(this RestClient<IUserClient> client, ulong id)
        {
        ...
        public static OAuth2Application GetApplication(this RestClient<IUserClient> client, ulong id)
        {
            return client.GetApplicationAsync(id).GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> CreateApplicationAsync(this RestClient<IUserClient> client, string name)
        {
        ...
        public static OAuth2Application CreateApplication(this RestClient<IUserClient> client, string name)
        {
            return client.CreateApplicationAsync(name).GetAwaiter().GetResult();
        }

        public static async Task<OAuth2Application> ModifyApplicationAsync(this RestClient<IUserClient> client, ulong id, DiscordApplicationProperties properties)
        {
        ...
        public static OAuth2Application ModifyApplication(this RestClient<IUserClient> client, ulong id, DiscordApplicationProperties properties)
        {
            return client.ModifyApplicationAsync(id, properties).GetAwaiter().GetResult();
        }

        public static async Task<ApplicationBot> AddBotToApplicationAsync(this RestClient<IUserClient> client, ulong appId)
        {
        ...
        /// <returns></returns>
        public static ApplicationBot AddBotToApplication(this RestClient<IUserClient> client, ulong appId)
        {
            return client.AddBotToApplicationAsync(appId).GetAwaiter().GetResult();
        }

        public static async Task DeleteApplicationAsync(this RestClient<IUserClient> client, ulong appId)
        {
        ...
        public static void DeleteApplication(this RestClient<IUserClient> client, ulong appId)
        {
