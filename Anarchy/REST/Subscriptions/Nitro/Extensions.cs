...
namespace Discord
{
    ...
    {
        public static async Task<IReadOnlyList<DiscordGuildSubscription>> BoostGuildAsync(this IRestClient client, ulong guildId, IEnumerable<ulong> boostSlots)
        {
        ...
        public static IReadOnlyList<DiscordGuildSubscription> BoostGuild(this IRestClient client, ulong guildId, IEnumerable<ulong> boosts)
        {
            return client.BoostGuildAsync(guildId, boosts).GetAwaiter().GetResult();
        }

        public static async Task RemoveGuildBoostAsync(this IRestClient client, ulong guildId, ulong subscriptionId)
        {
            await client.HttpClient.DeleteAsync($"/guilds/{guildId}/premium/subscriptions/{subscriptionId}");
        }

        public static void RemoveGuildBoost(this IRestClient client, ulong guildId, ulong subscriptionId)
        {
            client.RemoveGuildBoostAsync(guildId, subscriptionId).GetAwaiter().GetResult();
        }

        public static async Task<IReadOnlyList<DiscordBoostSlot>> GetBoostSlotsAsync(this IRestClient client)
        {
        ...
        public static IReadOnlyList<DiscordBoostSlot> GetBoostSlots(this IRestClient client)
        {
            return client.GetBoostSlotsAsync().GetAwaiter().GetResult();
        }

        public static async Task<DiscordActiveSubscription> SetAdditionalBoostsAsync(this IRestClient client, ulong paymentMethodId, ulong activeSubscriptionId, uint amount)
        {
        ...
        public static DiscordActiveSubscription SetAdditionalBoosts(this IRestClient client, ulong paymentMethodId, ulong activeSubscriptionId, uint amount)
        {
