...
namespace Discord
{
    ...
    {
        public static async Task<DiscordInvite> JoinGroupAsync(this IRestClient client, string inviteCode)
        {
        ...
        public static DiscordInvite JoinGroup(this IRestClient client, string inviteCode)
        {
            return client.JoinGroupAsync(inviteCode).GetAwaiter().GetResult();
        }

        public static async Task<DiscordGroup> CreateGroupAsync(this IRestClient client, List<ulong> recipients)
        {
        ...
        public static DiscordGroup CreateGroup(this IRestClient client, List<ulong> recipients)
        {
            return client.CreateGroupAsync(recipients).GetAwaiter().GetResult();
        }

        public static async Task<DiscordGroup> LeaveGroupAsync(this IRestClient client, ulong groupId)
        {
            return (DiscordGroup) await client.DeleteChannelAsync(groupId);
        }

        public static DiscordGroup LeaveGroup(this IRestClient client, ulong groupId)
        {
            return client.LeaveGroupAsync(groupId).GetAwaiter().GetResult();
        }

        public static async Task AddUserToGroupAsync(this IRestClient client, ulong groupId, ulong userId)
        {
        ...
        public static void AddUserToGroup(this IRestClient client, ulong groupId, ulong userId)
        {
            client.AddUserToGroupAsync(groupId, userId).GetAwaiter().GetResult();
        }

        public static async Task RemoveUserFromGroupAsync(this IRestClient client, ulong groupId, ulong userId)
        {
        ...
        /// <param name="groupId">ID of the group</param>
        /// <param name="userId">ID of the user</param>
        public static void RemoveUserFromGroup(this IRestClient client, ulong groupId, ulong userId)
        {
