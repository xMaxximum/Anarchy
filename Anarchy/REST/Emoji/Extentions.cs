...
namespace Discord
{
    ...
    {
        #region management
        public static async Task<DiscordEmoji> CreateEmojiAsync(this IRestClient client, ulong guildId, EmojiProperties properties)
        {
        ...
        public static DiscordEmoji CreateEmoji(this IRestClient client, ulong guildId, EmojiProperties properties)
        {
            return client.CreateEmojiAsync(guildId, properties).GetAwaiter().GetResult();
        }

        public static async Task<DiscordEmoji> ModifyEmojiAsync(this IRestClient client, ulong guildId, ulong emojiId, string name)
        {
        ...
        public static DiscordEmoji ModifyEmoji(this IRestClient client, ulong guildId, ulong emojiId, string name)
        {
            return client.ModifyEmojiAsync(guildId, emojiId, name).GetAwaiter().GetResult();
        }

        public static async Task DeleteEmojiAsync(this IRestClient client, ulong guildId, ulong emojiId)
        {
        ...
        /// <param name="guildId">ID of the guild</param>
        /// <param name="emojiId">ID of the emoji</param>
        public static void DeleteEmoji(this IRestClient client, ulong guildId, ulong emojiId)
        {
            client.DeleteEmojiAsync(guildId, emojiId).GetAwaiter().GetResult();
        }
        #endregion

        public static async Task<IReadOnlyList<DiscordEmoji>> GetGuildEmojisAsync(this IRestClient client, ulong guildId)
        {
        ...
        /// </summary>
        /// <param name="guildId">ID of the guild</param>
        public static IReadOnlyList<DiscordEmoji> GetGuildEmojis(this IRestClient client, ulong guildId)
        {
            return client.GetGuildEmojisAsync(guildId).GetAwaiter().GetResult();
        }

        public static async Task<DiscordEmoji> GetGuildEmojiAsync(this IRestClient client, ulong guildId, ulong emojiId)
        {
        ...
        /// <param name="guildId">ID of the guild</param>
        /// <param name="emojiId">ID of the emoji</param>
        public static DiscordEmoji GetGuildEmoji(this IRestClient client, ulong guildId, ulong emojiId)
        {
